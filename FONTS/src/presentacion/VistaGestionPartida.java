...
/**
 * VistaGestionPartida representa la interfaz gráfica para la gestión de partidas en el sistema Scrabble.
 * Permite al usuario crear una nueva partida, cargar una partida existente o volver atrás al menú anterior.
 *
 * <p>Componentes principales:
 * <ul>
 *   <li>panelTitulo: Panel con el título de la vista.</li>
 *   <li>panelBotones: Panel con los botones de acción para gestionar partidas.</li>
 * </ul>
 *
 ...
 * @author
 */
public class VistaGestionPartida extends JPanel {

    private JButton btnCrearNuevaPartida;
    private JButton btnCargarPartida;
    private JButton btnAtras;

    /**
     * Crea la vista de gestión de partida, inicializando los componentes gráficos y los listeners de los botones.
     *
     * @param controlador Referencia al controlador de presentación para la gestión de vistas y acciones.
     */
    public VistaGestionPartida(ControladorPresentacion controlador) {
        ...
        JLabel lblTitulo = new JLabel("GESTIÓN DE PARTIDA", SwingConstants.CENTER);
        ...
        btnCrearNuevaPartida = crearBoton("Crear Nueva Partida", new Color(255, 239, 213), new Dimension(250, 50));
        btnCargarPartida = crearBoton("Cargar Partida", new Color(255, 239, 213), new Dimension(250, 50));
        btnAtras = crearBoton("Atrás", new Color(255, 182, 193), new Dimension(150, 50));

        panelBotones.add(btnCrearNuevaPartida);
        ...
        btnCrearNuevaPartida.addActionListener(e -> controlador.manejarOpcionGestionPartida(1));
        btnCargarPartida.addActionListener(e -> controlador.manejarOpcionGestionPartida(2));
        btnAtras.addActionListener(e -> controlador.manejarOpcionGestionPartida(3));
    }
